...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount{}

// V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount GrpJobs
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxActiveJobsCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
