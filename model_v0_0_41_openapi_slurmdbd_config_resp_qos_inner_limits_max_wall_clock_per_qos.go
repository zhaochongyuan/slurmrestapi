...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos{}

// V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos GrpWall
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerQos) UnmarshalJSON(src []byte) error {
	v.isSet = true
