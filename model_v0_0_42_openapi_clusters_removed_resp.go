...
// checks if the V0042OpenapiClustersRemovedResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042OpenapiClustersRemovedResp{}
...
type _V0042OpenapiClustersRemovedResp V0042OpenapiClustersRemovedResp
...
func (o V0042OpenapiClustersRemovedResp) ToMap() (map[string]interface{}, error) {
...
func (o *V0042OpenapiClustersRemovedResp) UnmarshalJSON(data []byte) (err error) {
	...
	varV0042OpenapiClustersRemovedResp := _V0042OpenapiClustersRemovedResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0042OpenapiClustersRemovedResp)

	if err != nil {
		return err
	}

	*o = V0042OpenapiClustersRemovedResp(varV0042OpenapiClustersRemovedResp)
