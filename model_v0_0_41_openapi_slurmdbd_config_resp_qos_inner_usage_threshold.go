...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold{}

// V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold UsageThreshold
type V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold() *V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold(val *V0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerUsageThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
