...
// checks if the V0042License type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042License{}
...
func (o V0042License) ToMap() (map[string]interface{}, error) {
