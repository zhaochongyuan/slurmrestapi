...
// checks if the V0041OpenapiJobInfoRespJobsInnerTasksPerNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerTasksPerNode{}

// V0041OpenapiJobInfoRespJobsInnerTasksPerNode Number of tasks invoked on each node
type V0041OpenapiJobInfoRespJobsInnerTasksPerNode struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerTasksPerNode() *V0041OpenapiJobInfoRespJobsInnerTasksPerNode {
	this := V0041OpenapiJobInfoRespJobsInnerTasksPerNode{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerTasksPerNode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerTasksPerNode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode struct {
	value *V0041OpenapiJobInfoRespJobsInnerTasksPerNode
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) Get() *V0041OpenapiJobInfoRespJobsInnerTasksPerNode {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) Set(val *V0041OpenapiJobInfoRespJobsInnerTasksPerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode(val *V0041OpenapiJobInfoRespJobsInnerTasksPerNode) *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode {
	return &NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
