...
// checks if the V0041OpenapiJobInfoRespJobsInnerTasksPerSocket type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerTasksPerSocket{}

// V0041OpenapiJobInfoRespJobsInnerTasksPerSocket Number of tasks invoked on each socket
type V0041OpenapiJobInfoRespJobsInnerTasksPerSocket struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerTasksPerSocket() *V0041OpenapiJobInfoRespJobsInnerTasksPerSocket {
	this := V0041OpenapiJobInfoRespJobsInnerTasksPerSocket{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerTasksPerSocket) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerTasksPerSocket) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket struct {
	value *V0041OpenapiJobInfoRespJobsInnerTasksPerSocket
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) Get() *V0041OpenapiJobInfoRespJobsInnerTasksPerSocket {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) Set(val *V0041OpenapiJobInfoRespJobsInnerTasksPerSocket) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket(val *V0041OpenapiJobInfoRespJobsInnerTasksPerSocket) *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket {
	return &NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerTasksPerSocket) UnmarshalJSON(src []byte) error {
	v.isSet = true
