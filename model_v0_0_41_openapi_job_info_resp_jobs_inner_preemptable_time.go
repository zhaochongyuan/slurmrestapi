...
// checks if the V0041OpenapiJobInfoRespJobsInnerPreemptableTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerPreemptableTime{}

// V0041OpenapiJobInfoRespJobsInnerPreemptableTime Time job becomes eligible for preemption (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerPreemptableTime struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerPreemptableTime() *V0041OpenapiJobInfoRespJobsInnerPreemptableTime {
	this := V0041OpenapiJobInfoRespJobsInnerPreemptableTime{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerPreemptableTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerPreemptableTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime struct {
	value *V0041OpenapiJobInfoRespJobsInnerPreemptableTime
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) Get() *V0041OpenapiJobInfoRespJobsInnerPreemptableTime {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) Set(val *V0041OpenapiJobInfoRespJobsInnerPreemptableTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime(val *V0041OpenapiJobInfoRespJobsInnerPreemptableTime) *NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime {
	return &NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerPreemptableTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
