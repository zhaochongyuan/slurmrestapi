...
// checks if the V0041OpenapiDiagRespStatisticsReqTimeStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiDiagRespStatisticsReqTimeStart{}

// V0041OpenapiDiagRespStatisticsReqTimeStart When the data in the report started (UNIX timestamp)
type V0041OpenapiDiagRespStatisticsReqTimeStart struct {
...
func NewV0041OpenapiDiagRespStatisticsReqTimeStart() *V0041OpenapiDiagRespStatisticsReqTimeStart {
	this := V0041OpenapiDiagRespStatisticsReqTimeStart{}
	return &this
}
...
func (o V0041OpenapiDiagRespStatisticsReqTimeStart) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiDiagRespStatisticsReqTimeStart) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiDiagRespStatisticsReqTimeStart struct {
	value *V0041OpenapiDiagRespStatisticsReqTimeStart
	isSet bool
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTimeStart) Get() *V0041OpenapiDiagRespStatisticsReqTimeStart {
	return v.value
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTimeStart) Set(val *V0041OpenapiDiagRespStatisticsReqTimeStart) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTimeStart) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTimeStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiDiagRespStatisticsReqTimeStart(val *V0041OpenapiDiagRespStatisticsReqTimeStart) *NullableV0041OpenapiDiagRespStatisticsReqTimeStart {
	return &NullableV0041OpenapiDiagRespStatisticsReqTimeStart{value: val, isSet: true}
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTimeStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTimeStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
