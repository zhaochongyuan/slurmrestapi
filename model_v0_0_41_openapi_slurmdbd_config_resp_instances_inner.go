...
// checks if the V0041OpenapiSlurmdbdConfigRespInstancesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespInstancesInner{}

// V0041OpenapiSlurmdbdConfigRespInstancesInner struct for V0041OpenapiSlurmdbdConfigRespInstancesInner
type V0041OpenapiSlurmdbdConfigRespInstancesInner struct {
	// Cluster name
...
func NewV0041OpenapiSlurmdbdConfigRespInstancesInner() *V0041OpenapiSlurmdbdConfigRespInstancesInner {
	this := V0041OpenapiSlurmdbdConfigRespInstancesInner{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespInstancesInner) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespInstancesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespInstancesInner struct {
	value *V0041OpenapiSlurmdbdConfigRespInstancesInner
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) Get() *V0041OpenapiSlurmdbdConfigRespInstancesInner {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) Set(val *V0041OpenapiSlurmdbdConfigRespInstancesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespInstancesInner(val *V0041OpenapiSlurmdbdConfigRespInstancesInner) *NullableV0041OpenapiSlurmdbdConfigRespInstancesInner {
	return &NullableV0041OpenapiSlurmdbdConfigRespInstancesInner{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespInstancesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
