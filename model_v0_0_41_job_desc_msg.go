...
type V0041JobDescMsg struct {
	...
	BeginTime *V0041JobDescMsgBeginTime `json:"begin_time,omitempty"`
	// Job flags
	...
	Crontab *V0041JobDescMsgCrontab `json:"crontab,omitempty"`
	...
	DistributionPlaneSize *V0041JobDescMsgDistributionPlaneSize `json:"distribution_plane_size,omitempty"`
	// Deprecated
	...
	TimeLimit *V0041JobDescMsgTimeLimit `json:"time_limit,omitempty"`
	TimeMinimum *V0041JobDescMsgTimeMinimum `json:"time_minimum,omitempty"`
	...
	KillWarningDelay *V0041JobDescMsgKillWarningDelay `json:"kill_warning_delay,omitempty"`
	...
	MemoryPerCpu *V0041JobDescMsgMemoryPerCpu `json:"memory_per_cpu,omitempty"`
	MemoryPerNode *V0041JobDescMsgMemoryPerCpu `json:"memory_per_node,omitempty"`
	...
	RequiredSwitches *V0041JobDescMsgRequiredSwitches `json:"required_switches,omitempty"`
	SegmentSize *V0041JobDescMsgSegmentSize `json:"segment_size,omitempty"`
	// Path to stderr file
...
func (o *V0041JobDescMsg) GetBeginTime() V0041JobDescMsgBeginTime {
	if o == nil || IsNil(o.BeginTime) {
		var ret V0041JobDescMsgBeginTime
		return ret
	}
	return *o.BeginTime
}
...
// SetBeginTime gets a reference to the given V0041JobDescMsgBeginTime and assigns it to the BeginTime field.
func (o *V0041JobDescMsg) SetBeginTime(v V0041JobDescMsgBeginTime) {
	o.BeginTime = &v
}
...
func (o *V0041JobDescMsg) GetCrontab() V0041JobDescMsgCrontab {
	if o == nil || IsNil(o.Crontab) {
		var ret V0041JobDescMsgCrontab
		return ret
	}
	return *o.Crontab
}
...
// SetCrontab gets a reference to the given V0041JobDescMsgCrontab and assigns it to the Crontab field.
...
// SetDistributionPlaneSize gets a reference to the given V0041JobDescMsgDistributionPlaneSize and assigns it to the DistributionPlaneSize field.
...
func (o *V0041JobDescMsg) GetTimeLimit() V0041JobDescMsgTimeLimit {
	if o == nil || IsNil(o.TimeLimit) {
		var ret V0041JobDescMsgTimeLimit
		return ret
	}
	return *o.TimeLimit
}
...
// and a boolean to check if the value has been set.
func (o *V0041JobDescMsg) GetTimeLimitOk() (*V0041JobDescMsgTimeLimit, bool) {
	if o == nil || IsNil(o.TimeLimit) {
		return nil, false
	}
...
// SetTimeLimit gets a reference to the given V0041JobDescMsgTimeLimit and assigns it to the TimeLimit field.
...
func (o *V0041JobDescMsg) GetTimeMinimum() V0041JobDescMsgTimeMinimum {
	if o == nil || IsNil(o.TimeMinimum) {
		var ret V0041JobDescMsgTimeMinimum
		return ret
	}
...
// SetTimeMinimum gets a reference to the given V0041JobDescMsgTimeMinimum and assigns it to the TimeMinimum field.
...
func (o *V0041JobDescMsg) GetKillWarningDelay() V0041JobDescMsgKillWarningDelay {
	if o == nil || IsNil(o.KillWarningDelay) {
		var ret V0041JobDescMsgKillWarningDelay
		return ret
	}
...
// SetKillWarningDelay gets a reference to the given V0041JobDescMsgKillWarningDelay and assigns it to the KillWarningDelay field.
...
func (o *V0041JobDescMsg) GetMemoryPerCpu() V0041JobDescMsgMemoryPerCpu {
	if o == nil || IsNil(o.MemoryPerCpu) {
		var ret V0041JobDescMsgMemoryPerCpu
		return ret
	}
...
// SetMemoryPerCpu gets a reference to the given V0041JobDescMsgMemoryPerCpu and assigns it to the MemoryPerCpu field.
...
// SetMemoryPerNode gets a reference to the given V0041JobDescMsgMemoryPerCpu and assigns it to the MemoryPerNode field.
...
func (o *V0041JobDescMsg) GetRequiredSwitches() V0041JobDescMsgRequiredSwitches {
	if o == nil || IsNil(o.RequiredSwitches) {
		var ret V0041JobDescMsgRequiredSwitches
		return ret
	}
...
// SetRequiredSwitches gets a reference to the given V0041JobDescMsgRequiredSwitches and assigns it to the RequiredSwitches field.
...
func (o *V0041JobDescMsg) GetSegmentSize() V0041JobDescMsgSegmentSize {
	if o == nil || IsNil(o.SegmentSize) {
		var ret V0041JobDescMsgSegmentSize
		return ret
	}
...
// SetSegmentSize gets a reference to the given V0041JobDescMsgSegmentSize and assigns it to the SegmentSize field.
