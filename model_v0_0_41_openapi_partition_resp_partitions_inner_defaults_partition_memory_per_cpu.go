...
// checks if the V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu{}

// V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu DefMemPerCPU
type V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu struct {
...
func NewV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu() *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu {
	this := V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu{}
	return &this
}
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu struct {
	value *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu
	isSet bool
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) Get() *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu {
	return v.value
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) Set(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu {
	return &NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu{value: val, isSet: true}
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerCpu) UnmarshalJSON(src []byte) error {
	v.isSet = true
