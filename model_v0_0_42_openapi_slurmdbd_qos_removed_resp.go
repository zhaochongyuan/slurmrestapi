...
// checks if the V0042OpenapiSlurmdbdQosRemovedResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042OpenapiSlurmdbdQosRemovedResp{}
...
type _V0042OpenapiSlurmdbdQosRemovedResp V0042OpenapiSlurmdbdQosRemovedResp
...
func (o V0042OpenapiSlurmdbdQosRemovedResp) ToMap() (map[string]interface{}, error) {
...
func (o *V0042OpenapiSlurmdbdQosRemovedResp) UnmarshalJSON(data []byte) (err error) {
	...
	varV0042OpenapiSlurmdbdQosRemovedResp := _V0042OpenapiSlurmdbdQosRemovedResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0042OpenapiSlurmdbdQosRemovedResp)

	if err != nil {
		return err
	}

	*o = V0042OpenapiSlurmdbdQosRemovedResp(varV0042OpenapiSlurmdbdQosRemovedResp)
