...
// checks if the V0041OpenapiNodesRespNodesInnerBootTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiNodesRespNodesInnerBootTime{}

// V0041OpenapiNodesRespNodesInnerBootTime Time when the node booted (UNIX timestamp)
type V0041OpenapiNodesRespNodesInnerBootTime struct {
...
func NewV0041OpenapiNodesRespNodesInnerBootTime() *V0041OpenapiNodesRespNodesInnerBootTime {
	this := V0041OpenapiNodesRespNodesInnerBootTime{}
	return &this
}
...
func (o V0041OpenapiNodesRespNodesInnerBootTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiNodesRespNodesInnerBootTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiNodesRespNodesInnerBootTime struct {
	value *V0041OpenapiNodesRespNodesInnerBootTime
	isSet bool
}

func (v NullableV0041OpenapiNodesRespNodesInnerBootTime) Get() *V0041OpenapiNodesRespNodesInnerBootTime {
	return v.value
}

func (v *NullableV0041OpenapiNodesRespNodesInnerBootTime) Set(val *V0041OpenapiNodesRespNodesInnerBootTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiNodesRespNodesInnerBootTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiNodesRespNodesInnerBootTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiNodesRespNodesInnerBootTime(val *V0041OpenapiNodesRespNodesInnerBootTime) *NullableV0041OpenapiNodesRespNodesInnerBootTime {
	return &NullableV0041OpenapiNodesRespNodesInnerBootTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiNodesRespNodesInnerBootTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiNodesRespNodesInnerBootTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
