...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerPriority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerPriority{}

// V0041OpenapiSlurmdbdConfigRespQosInnerPriority Priority
type V0041OpenapiSlurmdbdConfigRespQosInnerPriority struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerPriority() *V0041OpenapiSlurmdbdConfigRespQosInnerPriority {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerPriority{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerPriority) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerPriority) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerPriority
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerPriority {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerPriority) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority(val *V0041OpenapiSlurmdbdConfigRespQosInnerPriority) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
