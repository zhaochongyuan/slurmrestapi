...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime{}

// V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime PreemptExemptTime
type V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime() *V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime(val *V0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerPreemptExemptTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
