...
// checks if the V0041JobDescMsgTimeLimit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgTimeLimit{}

// V0041JobDescMsgTimeLimit Maximum run time in minutes
type V0041JobDescMsgTimeLimit struct {
...
func (o V0041JobDescMsgTimeLimit) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgTimeLimit) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgTimeLimit struct {
	value *V0041JobDescMsgTimeLimit
	isSet bool
}

func (v NullableV0041JobDescMsgTimeLimit) Get() *V0041JobDescMsgTimeLimit {
	return v.value
}

func (v *NullableV0041JobDescMsgTimeLimit) Set(val *V0041JobDescMsgTimeLimit) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgTimeLimit) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgTimeLimit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgTimeLimit(val *V0041JobDescMsgTimeLimit) *NullableV0041JobDescMsgTimeLimit {
	return &NullableV0041JobDescMsgTimeLimit{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgTimeLimit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgTimeLimit) UnmarshalJSON(src []byte) error {
	v.isSet = true
