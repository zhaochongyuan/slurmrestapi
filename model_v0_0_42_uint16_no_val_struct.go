...
// checks if the V0042Uint16NoValStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042Uint16NoValStruct{}

// V0042Uint16NoValStruct struct for V0042Uint16NoValStruct
...
func (o V0042Uint16NoValStruct) MarshalJSON() ([]byte, error) {
...
func (o V0042Uint16NoValStruct) ToMap() (map[string]interface{}, error) {
...
type NullableV0042Uint16NoValStruct struct {
	value *V0042Uint16NoValStruct
	isSet bool
}

func (v NullableV0042Uint16NoValStruct) Get() *V0042Uint16NoValStruct {
	return v.value
}

func (v *NullableV0042Uint16NoValStruct) Set(val *V0042Uint16NoValStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042Uint16NoValStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042Uint16NoValStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042Uint16NoValStruct(val *V0042Uint16NoValStruct) *NullableV0042Uint16NoValStruct {
	return &NullableV0042Uint16NoValStruct{value: val, isSet: true}
}

func (v NullableV0042Uint16NoValStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042Uint16NoValStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
