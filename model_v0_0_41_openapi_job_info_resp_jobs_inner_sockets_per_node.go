...
// checks if the V0041OpenapiJobInfoRespJobsInnerSocketsPerNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerSocketsPerNode{}

// V0041OpenapiJobInfoRespJobsInnerSocketsPerNode Number of sockets per node required
type V0041OpenapiJobInfoRespJobsInnerSocketsPerNode struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerSocketsPerNode() *V0041OpenapiJobInfoRespJobsInnerSocketsPerNode {
	this := V0041OpenapiJobInfoRespJobsInnerSocketsPerNode{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerSocketsPerNode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerSocketsPerNode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode struct {
	value *V0041OpenapiJobInfoRespJobsInnerSocketsPerNode
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) Get() *V0041OpenapiJobInfoRespJobsInnerSocketsPerNode {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) Set(val *V0041OpenapiJobInfoRespJobsInnerSocketsPerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode(val *V0041OpenapiJobInfoRespJobsInnerSocketsPerNode) *NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode {
	return &NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSocketsPerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
