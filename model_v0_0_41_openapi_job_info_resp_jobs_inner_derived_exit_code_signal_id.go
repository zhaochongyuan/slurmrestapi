...
// checks if the V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId{}

// V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId Signal sent to process (numeric)
type V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId() *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId {
	this := V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId struct {
	value *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) Get() *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) Set(val *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId(val *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId {
	return &NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeSignalId) UnmarshalJSON(src []byte) error {
	v.isSet = true
