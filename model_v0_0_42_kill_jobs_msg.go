...
// checks if the V0042KillJobsMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042KillJobsMsg{}
...
func (o V0042KillJobsMsg) ToMap() (map[string]interface{}, error) {
