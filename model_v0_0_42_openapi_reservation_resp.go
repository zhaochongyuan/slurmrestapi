...
// checks if the V0042OpenapiReservationResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042OpenapiReservationResp{}

// V0042OpenapiReservationResp struct for V0042OpenapiReservationResp
type V0042OpenapiReservationResp struct {
	Reservations []V0042ReservationInfo `json:"reservations"`
...
type _V0042OpenapiReservationResp V0042OpenapiReservationResp
...
func NewV0042OpenapiReservationResp(reservations []V0042ReservationInfo, lastUpdate V0042Uint64NoValStruct) *V0042OpenapiReservationResp {
	this := V0042OpenapiReservationResp{}
...
func (o V0042OpenapiReservationResp) MarshalJSON() ([]byte, error) {
...
func (o V0042OpenapiReservationResp) ToMap() (map[string]interface{}, error) {
...
func (o *V0042OpenapiReservationResp) UnmarshalJSON(data []byte) (err error) {
	...
	varV0042OpenapiReservationResp := _V0042OpenapiReservationResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0042OpenapiReservationResp)

	if err != nil {
		return err
	}

	*o = V0042OpenapiReservationResp(varV0042OpenapiReservationResp)

	return err
}

type NullableV0042OpenapiReservationResp struct {
	value *V0042OpenapiReservationResp
	isSet bool
}

func (v NullableV0042OpenapiReservationResp) Get() *V0042OpenapiReservationResp {
	return v.value
}

func (v *NullableV0042OpenapiReservationResp) Set(val *V0042OpenapiReservationResp) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042OpenapiReservationResp) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042OpenapiReservationResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042OpenapiReservationResp(val *V0042OpenapiReservationResp) *NullableV0042OpenapiReservationResp {
	return &NullableV0042OpenapiReservationResp{value: val, isSet: true}
}

func (v NullableV0042OpenapiReservationResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042OpenapiReservationResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
