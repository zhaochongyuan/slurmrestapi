...
// checks if the V0041JobDescMsgSegmentSize type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgSegmentSize{}

// V0041JobDescMsgSegmentSize Segment size for topology/block
type V0041JobDescMsgSegmentSize struct {
...
func NewV0041JobDescMsgSegmentSize() *V0041JobDescMsgSegmentSize {
	this := V0041JobDescMsgSegmentSize{}
	return &this
}
...
func (o V0041JobDescMsgSegmentSize) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgSegmentSize) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgSegmentSize struct {
	value *V0041JobDescMsgSegmentSize
	isSet bool
}

func (v NullableV0041JobDescMsgSegmentSize) Get() *V0041JobDescMsgSegmentSize {
	return v.value
}

func (v *NullableV0041JobDescMsgSegmentSize) Set(val *V0041JobDescMsgSegmentSize) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgSegmentSize) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgSegmentSize) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgSegmentSize(val *V0041JobDescMsgSegmentSize) *NullableV0041JobDescMsgSegmentSize {
	return &NullableV0041JobDescMsgSegmentSize{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgSegmentSize) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgSegmentSize) UnmarshalJSON(src []byte) error {
	v.isSet = true
