...
// checks if the V0042Uint32NoValStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042Uint32NoValStruct{}

// V0042Uint32NoValStruct struct for V0042Uint32NoValStruct
...
func (o V0042Uint32NoValStruct) MarshalJSON() ([]byte, error) {
...
func (o V0042Uint32NoValStruct) ToMap() (map[string]interface{}, error) {
...
type NullableV0042Uint32NoValStruct struct {
	value *V0042Uint32NoValStruct
	isSet bool
}

func (v NullableV0042Uint32NoValStruct) Get() *V0042Uint32NoValStruct {
	return v.value
}

func (v *NullableV0042Uint32NoValStruct) Set(val *V0042Uint32NoValStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042Uint32NoValStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042Uint32NoValStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042Uint32NoValStruct(val *V0042Uint32NoValStruct) *NullableV0042Uint32NoValStruct {
	return &NullableV0042Uint32NoValStruct{value: val, isSet: true}
}

func (v NullableV0042Uint32NoValStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042Uint32NoValStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
