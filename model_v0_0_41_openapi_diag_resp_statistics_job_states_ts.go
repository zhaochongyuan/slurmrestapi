...
// checks if the V0041OpenapiDiagRespStatisticsJobStatesTs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiDiagRespStatisticsJobStatesTs{}

// V0041OpenapiDiagRespStatisticsJobStatesTs When the job state counts were gathered (UNIX timestamp)
type V0041OpenapiDiagRespStatisticsJobStatesTs struct {
...
func NewV0041OpenapiDiagRespStatisticsJobStatesTs() *V0041OpenapiDiagRespStatisticsJobStatesTs {
	this := V0041OpenapiDiagRespStatisticsJobStatesTs{}
	return &this
}
...
func (o V0041OpenapiDiagRespStatisticsJobStatesTs) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiDiagRespStatisticsJobStatesTs) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiDiagRespStatisticsJobStatesTs struct {
	value *V0041OpenapiDiagRespStatisticsJobStatesTs
	isSet bool
}

func (v NullableV0041OpenapiDiagRespStatisticsJobStatesTs) Get() *V0041OpenapiDiagRespStatisticsJobStatesTs {
	return v.value
}

func (v *NullableV0041OpenapiDiagRespStatisticsJobStatesTs) Set(val *V0041OpenapiDiagRespStatisticsJobStatesTs) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiDiagRespStatisticsJobStatesTs) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiDiagRespStatisticsJobStatesTs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiDiagRespStatisticsJobStatesTs(val *V0041OpenapiDiagRespStatisticsJobStatesTs) *NullableV0041OpenapiDiagRespStatisticsJobStatesTs {
	return &NullableV0041OpenapiDiagRespStatisticsJobStatesTs{value: val, isSet: true}
}

func (v NullableV0041OpenapiDiagRespStatisticsJobStatesTs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiDiagRespStatisticsJobStatesTs) UnmarshalJSON(src []byte) error {
	v.isSet = true
