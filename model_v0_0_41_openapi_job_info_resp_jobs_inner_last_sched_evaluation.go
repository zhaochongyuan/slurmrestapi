...
// checks if the V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation{}

// V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation Last time job was evaluated for scheduling (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation() *V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation {
	this := V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation struct {
	value *V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) Get() *V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) Set(val *V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation(val *V0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) *NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation {
	return &NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerLastSchedEvaluation) UnmarshalJSON(src []byte) error {
	v.isSet = true
