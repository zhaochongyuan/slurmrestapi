...
// checks if the V0041OpenapiJobInfoRespLastUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespLastUpdate{}

// V0041OpenapiJobInfoRespLastUpdate Time of last job change (UNIX timestamp)
type V0041OpenapiJobInfoRespLastUpdate struct {
...
func NewV0041OpenapiJobInfoRespLastUpdate() *V0041OpenapiJobInfoRespLastUpdate {
	this := V0041OpenapiJobInfoRespLastUpdate{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespLastUpdate) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespLastUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespLastUpdate struct {
	value *V0041OpenapiJobInfoRespLastUpdate
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespLastUpdate) Get() *V0041OpenapiJobInfoRespLastUpdate {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespLastUpdate) Set(val *V0041OpenapiJobInfoRespLastUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespLastUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespLastUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespLastUpdate(val *V0041OpenapiJobInfoRespLastUpdate) *NullableV0041OpenapiJobInfoRespLastUpdate {
	return &NullableV0041OpenapiJobInfoRespLastUpdate{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespLastUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespLastUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
