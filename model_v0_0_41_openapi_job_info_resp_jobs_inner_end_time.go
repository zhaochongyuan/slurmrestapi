...
// checks if the V0041OpenapiJobInfoRespJobsInnerEndTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerEndTime{}

// V0041OpenapiJobInfoRespJobsInnerEndTime End time, real or expected (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerEndTime struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerEndTime() *V0041OpenapiJobInfoRespJobsInnerEndTime {
	this := V0041OpenapiJobInfoRespJobsInnerEndTime{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerEndTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerEndTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerEndTime struct {
	value *V0041OpenapiJobInfoRespJobsInnerEndTime
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerEndTime) Get() *V0041OpenapiJobInfoRespJobsInnerEndTime {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerEndTime) Set(val *V0041OpenapiJobInfoRespJobsInnerEndTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerEndTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerEndTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerEndTime(val *V0041OpenapiJobInfoRespJobsInnerEndTime) *NullableV0041OpenapiJobInfoRespJobsInnerEndTime {
	return &NullableV0041OpenapiJobInfoRespJobsInnerEndTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerEndTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerEndTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
