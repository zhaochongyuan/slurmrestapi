...
// checks if the V0041OpenapiJobInfoRespJobsInnerDelayBoot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerDelayBoot{}

// V0041OpenapiJobInfoRespJobsInnerDelayBoot Number of seconds after job eligible start that nodes will be rebooted to satisfy feature specification
type V0041OpenapiJobInfoRespJobsInnerDelayBoot struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerDelayBoot() *V0041OpenapiJobInfoRespJobsInnerDelayBoot {
	this := V0041OpenapiJobInfoRespJobsInnerDelayBoot{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerDelayBoot) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerDelayBoot) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot struct {
	value *V0041OpenapiJobInfoRespJobsInnerDelayBoot
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) Get() *V0041OpenapiJobInfoRespJobsInnerDelayBoot {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) Set(val *V0041OpenapiJobInfoRespJobsInnerDelayBoot) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerDelayBoot(val *V0041OpenapiJobInfoRespJobsInnerDelayBoot) *NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot {
	return &NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDelayBoot) UnmarshalJSON(src []byte) error {
	v.isSet = true
