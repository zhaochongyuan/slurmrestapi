...
// checks if the V0042JobDescMsgRlimits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042JobDescMsgRlimits{}

// V0042JobDescMsgRlimits struct for V0042JobDescMsgRlimits
type V0042JobDescMsgRlimits struct {
...
// SetCpu gets a reference to the given V0042Uint64NoValStruct and assigns it to the Cpu field.
func (o *V0042JobDescMsgRlimits) SetCpu(v V0042Uint64NoValStruct) {
	o.Cpu = &v
}
...
// SetFsize gets a reference to the given V0042Uint64NoValStruct and assigns it to the Fsize field.
...
// SetData gets a reference to the given V0042Uint64NoValStruct and assigns it to the Data field.
...
// SetStack gets a reference to the given V0042Uint64NoValStruct and assigns it to the Stack field.
...
// SetCore gets a reference to the given V0042Uint64NoValStruct and assigns it to the Core field.
...
// SetRss gets a reference to the given V0042Uint64NoValStruct and assigns it to the Rss field.
...
// SetNproc gets a reference to the given V0042Uint64NoValStruct and assigns it to the Nproc field.
...
// SetNofile gets a reference to the given V0042Uint64NoValStruct and assigns it to the Nofile field.
...
// SetMemlock gets a reference to the given V0042Uint64NoValStruct and assigns it to the Memlock field.
...
// SetAs gets a reference to the given V0042Uint64NoValStruct and assigns it to the As field.
func (o *V0042JobDescMsgRlimits) SetAs(v V0042Uint64NoValStruct) {
	o.As = &v
}

func (o V0042JobDescMsgRlimits) MarshalJSON() ([]byte, error) {
...
func (o V0042JobDescMsgRlimits) ToMap() (map[string]interface{}, error) {
...
type NullableV0042JobDescMsgRlimits struct {
	value *V0042JobDescMsgRlimits
	isSet bool
}

func (v NullableV0042JobDescMsgRlimits) Get() *V0042JobDescMsgRlimits {
	return v.value
}

func (v *NullableV0042JobDescMsgRlimits) Set(val *V0042JobDescMsgRlimits) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042JobDescMsgRlimits) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042JobDescMsgRlimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042JobDescMsgRlimits(val *V0042JobDescMsgRlimits) *NullableV0042JobDescMsgRlimits {
	return &NullableV0042JobDescMsgRlimits{value: val, isSet: true}
}

func (v NullableV0042JobDescMsgRlimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042JobDescMsgRlimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
