...
// checks if the V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks{}

// V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks Maximum number of simultaneously running array tasks, 0 if no limit
type V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks() *V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks {
	this := V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks struct {
	value *V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) Get() *V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) Set(val *V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks(val *V0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) *NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks {
	return &NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerArrayMaxTasks) UnmarshalJSON(src []byte) error {
	v.isSet = true
