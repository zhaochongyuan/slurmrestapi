...
// checks if the V0041OpenapiNodesRespNodesInnerLastBusy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiNodesRespNodesInnerLastBusy{}

// V0041OpenapiNodesRespNodesInnerLastBusy Time when the node was last busy (UNIX timestamp)
type V0041OpenapiNodesRespNodesInnerLastBusy struct {
...
func NewV0041OpenapiNodesRespNodesInnerLastBusy() *V0041OpenapiNodesRespNodesInnerLastBusy {
	this := V0041OpenapiNodesRespNodesInnerLastBusy{}
	return &this
}
...
func (o V0041OpenapiNodesRespNodesInnerLastBusy) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiNodesRespNodesInnerLastBusy) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiNodesRespNodesInnerLastBusy struct {
	value *V0041OpenapiNodesRespNodesInnerLastBusy
	isSet bool
}

func (v NullableV0041OpenapiNodesRespNodesInnerLastBusy) Get() *V0041OpenapiNodesRespNodesInnerLastBusy {
	return v.value
}

func (v *NullableV0041OpenapiNodesRespNodesInnerLastBusy) Set(val *V0041OpenapiNodesRespNodesInnerLastBusy) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiNodesRespNodesInnerLastBusy) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiNodesRespNodesInnerLastBusy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiNodesRespNodesInnerLastBusy(val *V0041OpenapiNodesRespNodesInnerLastBusy) *NullableV0041OpenapiNodesRespNodesInnerLastBusy {
	return &NullableV0041OpenapiNodesRespNodesInnerLastBusy{value: val, isSet: true}
}

func (v NullableV0041OpenapiNodesRespNodesInnerLastBusy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiNodesRespNodesInnerLastBusy) UnmarshalJSON(src []byte) error {
	v.isSet = true
