...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs Maximum number of jobs which can be in a pending or running state at any time in this association
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMaxsubmitjobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
