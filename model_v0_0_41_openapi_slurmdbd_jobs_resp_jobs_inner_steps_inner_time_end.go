...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd End time (UNIX timestamp)
type V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeEnd) UnmarshalJSON(src []byte) error {
	v.isSet = true
