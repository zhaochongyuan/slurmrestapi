...
// checks if the V0041OpenapiJobInfoRespJobsInnerDeadline type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerDeadline{}

// V0041OpenapiJobInfoRespJobsInnerDeadline Latest time that the job may start (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerDeadline struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerDeadline() *V0041OpenapiJobInfoRespJobsInnerDeadline {
	this := V0041OpenapiJobInfoRespJobsInnerDeadline{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerDeadline) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerDeadline) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerDeadline struct {
	value *V0041OpenapiJobInfoRespJobsInnerDeadline
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDeadline) Get() *V0041OpenapiJobInfoRespJobsInnerDeadline {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDeadline) Set(val *V0041OpenapiJobInfoRespJobsInnerDeadline) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDeadline) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDeadline) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerDeadline(val *V0041OpenapiJobInfoRespJobsInnerDeadline) *NullableV0041OpenapiJobInfoRespJobsInnerDeadline {
	return &NullableV0041OpenapiJobInfoRespJobsInnerDeadline{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDeadline) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDeadline) UnmarshalJSON(src []byte) error {
	v.isSet = true
