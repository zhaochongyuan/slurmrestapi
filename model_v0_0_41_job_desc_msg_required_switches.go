...
// checks if the V0041JobDescMsgRequiredSwitches type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRequiredSwitches{}

// V0041JobDescMsgRequiredSwitches Maximum number of switches
type V0041JobDescMsgRequiredSwitches struct {
...
func NewV0041JobDescMsgRequiredSwitches() *V0041JobDescMsgRequiredSwitches {
	this := V0041JobDescMsgRequiredSwitches{}
	return &this
}
...
func (o V0041JobDescMsgRequiredSwitches) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRequiredSwitches) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRequiredSwitches struct {
	value *V0041JobDescMsgRequiredSwitches
	isSet bool
}

func (v NullableV0041JobDescMsgRequiredSwitches) Get() *V0041JobDescMsgRequiredSwitches {
	return v.value
}

func (v *NullableV0041JobDescMsgRequiredSwitches) Set(val *V0041JobDescMsgRequiredSwitches) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRequiredSwitches) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRequiredSwitches) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRequiredSwitches(val *V0041JobDescMsgRequiredSwitches) *NullableV0041JobDescMsgRequiredSwitches {
	return &NullableV0041JobDescMsgRequiredSwitches{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRequiredSwitches) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRequiredSwitches) UnmarshalJSON(src []byte) error {
	v.isSet = true
