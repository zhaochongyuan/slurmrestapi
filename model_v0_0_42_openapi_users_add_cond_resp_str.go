...
// checks if the V0042OpenapiUsersAddCondRespStr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042OpenapiUsersAddCondRespStr{}

// V0042OpenapiUsersAddCondRespStr struct for V0042OpenapiUsersAddCondRespStr
...
type _V0042OpenapiUsersAddCondRespStr V0042OpenapiUsersAddCondRespStr
...
func NewV0042OpenapiUsersAddCondRespStr(addedUsers string) *V0042OpenapiUsersAddCondRespStr {
	this := V0042OpenapiUsersAddCondRespStr{}
...
func (o V0042OpenapiUsersAddCondRespStr) MarshalJSON() ([]byte, error) {
...
func (o V0042OpenapiUsersAddCondRespStr) ToMap() (map[string]interface{}, error) {
...
func (o *V0042OpenapiUsersAddCondRespStr) UnmarshalJSON(data []byte) (err error) {
	...
	varV0042OpenapiUsersAddCondRespStr := _V0042OpenapiUsersAddCondRespStr{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0042OpenapiUsersAddCondRespStr)

	if err != nil {
		return err
	}

	*o = V0042OpenapiUsersAddCondRespStr(varV0042OpenapiUsersAddCondRespStr)

	return err
}

type NullableV0042OpenapiUsersAddCondRespStr struct {
	value *V0042OpenapiUsersAddCondRespStr
	isSet bool
}

func (v NullableV0042OpenapiUsersAddCondRespStr) Get() *V0042OpenapiUsersAddCondRespStr {
	return v.value
}

func (v *NullableV0042OpenapiUsersAddCondRespStr) Set(val *V0042OpenapiUsersAddCondRespStr) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042OpenapiUsersAddCondRespStr) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042OpenapiUsersAddCondRespStr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042OpenapiUsersAddCondRespStr(val *V0042OpenapiUsersAddCondRespStr) *NullableV0042OpenapiUsersAddCondRespStr {
	return &NullableV0042OpenapiUsersAddCondRespStr{value: val, isSet: true}
}

func (v NullableV0042OpenapiUsersAddCondRespStr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042OpenapiUsersAddCondRespStr) UnmarshalJSON(src []byte) error {
	v.isSet = true
