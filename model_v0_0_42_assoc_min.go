...
// checks if the V0042AssocMin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042AssocMin{}
...
func (o V0042AssocMin) ToMap() (map[string]interface{}, error) {
