...
// checks if the V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum{}

// V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum Minimum CPU frequency
type V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum() *V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum {
	this := V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum struct {
	value *V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) Get() *V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) Set(val *V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum(val *V0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) *NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum {
	return &NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerCpuFrequencyMinimum) UnmarshalJSON(src []byte) error {
	v.isSet = true
