...
// checks if the V0041JobDescMsgRlimitsNofile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRlimitsNofile{}

// V0041JobDescMsgRlimitsNofile Number of open files.
type V0041JobDescMsgRlimitsNofile struct {
...
func NewV0041JobDescMsgRlimitsNofile() *V0041JobDescMsgRlimitsNofile {
	this := V0041JobDescMsgRlimitsNofile{}
	return &this
}
...
func (o V0041JobDescMsgRlimitsNofile) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRlimitsNofile) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRlimitsNofile struct {
	value *V0041JobDescMsgRlimitsNofile
	isSet bool
}

func (v NullableV0041JobDescMsgRlimitsNofile) Get() *V0041JobDescMsgRlimitsNofile {
	return v.value
}

func (v *NullableV0041JobDescMsgRlimitsNofile) Set(val *V0041JobDescMsgRlimitsNofile) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRlimitsNofile) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRlimitsNofile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRlimitsNofile(val *V0041JobDescMsgRlimitsNofile) *NullableV0041JobDescMsgRlimitsNofile {
	return &NullableV0041JobDescMsgRlimitsNofile{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRlimitsNofile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRlimitsNofile) UnmarshalJSON(src []byte) error {
	v.isSet = true
