...
// checks if the V0042UpdateNodeMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042UpdateNodeMsg{}

// V0042UpdateNodeMsg struct for V0042UpdateNodeMsg
...
// SetResumeAfter gets a reference to the given V0042Uint32NoValStruct and assigns it to the ResumeAfter field.
...
// SetWeight gets a reference to the given V0042Uint32NoValStruct and assigns it to the Weight field.
func (o *V0042UpdateNodeMsg) SetWeight(v V0042Uint32NoValStruct) {
	o.Weight = &v
}

func (o V0042UpdateNodeMsg) MarshalJSON() ([]byte, error) {
...
func (o V0042UpdateNodeMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0042UpdateNodeMsg struct {
	value *V0042UpdateNodeMsg
	isSet bool
}

func (v NullableV0042UpdateNodeMsg) Get() *V0042UpdateNodeMsg {
	return v.value
}

func (v *NullableV0042UpdateNodeMsg) Set(val *V0042UpdateNodeMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042UpdateNodeMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042UpdateNodeMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042UpdateNodeMsg(val *V0042UpdateNodeMsg) *NullableV0042UpdateNodeMsg {
	return &NullableV0042UpdateNodeMsg{value: val, isSet: true}
}

func (v NullableV0042UpdateNodeMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042UpdateNodeMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
