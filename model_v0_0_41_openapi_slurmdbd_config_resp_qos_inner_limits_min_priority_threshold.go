...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold{}

// V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold MinPrioThreshold
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMinPriorityThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
