...
// checks if the V0041OpenapiJobInfoRespJobsInnerMaxCpus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerMaxCpus{}

// V0041OpenapiJobInfoRespJobsInnerMaxCpus Maximum number of CPUs usable by the job
type V0041OpenapiJobInfoRespJobsInnerMaxCpus struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerMaxCpus() *V0041OpenapiJobInfoRespJobsInnerMaxCpus {
	this := V0041OpenapiJobInfoRespJobsInnerMaxCpus{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerMaxCpus) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerMaxCpus) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus struct {
	value *V0041OpenapiJobInfoRespJobsInnerMaxCpus
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) Get() *V0041OpenapiJobInfoRespJobsInnerMaxCpus {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) Set(val *V0041OpenapiJobInfoRespJobsInnerMaxCpus) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerMaxCpus(val *V0041OpenapiJobInfoRespJobsInnerMaxCpus) *NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus {
	return &NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxCpus) UnmarshalJSON(src []byte) error {
	v.isSet = true
