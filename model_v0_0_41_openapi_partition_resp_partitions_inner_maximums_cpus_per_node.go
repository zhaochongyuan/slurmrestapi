...
// checks if the V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode{}

// V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode MaxCPUsPerNode
type V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode struct {
...
func NewV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode() *V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode {
	this := V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode{}
	return &this
}
...
func (o V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode struct {
	value *V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode
	isSet bool
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) Get() *V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode {
	return v.value
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) Set(val *V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode(val *V0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode {
	return &NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode{value: val, isSet: true}
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsCpusPerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
