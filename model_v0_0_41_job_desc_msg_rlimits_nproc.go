...
// checks if the V0041JobDescMsgRlimitsNproc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRlimitsNproc{}

// V0041JobDescMsgRlimitsNproc Number of processes.
type V0041JobDescMsgRlimitsNproc struct {
...
func NewV0041JobDescMsgRlimitsNproc() *V0041JobDescMsgRlimitsNproc {
	this := V0041JobDescMsgRlimitsNproc{}
	return &this
}
...
func (o V0041JobDescMsgRlimitsNproc) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRlimitsNproc) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRlimitsNproc struct {
	value *V0041JobDescMsgRlimitsNproc
	isSet bool
}

func (v NullableV0041JobDescMsgRlimitsNproc) Get() *V0041JobDescMsgRlimitsNproc {
	return v.value
}

func (v *NullableV0041JobDescMsgRlimitsNproc) Set(val *V0041JobDescMsgRlimitsNproc) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRlimitsNproc) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRlimitsNproc) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRlimitsNproc(val *V0041JobDescMsgRlimitsNproc) *NullableV0041JobDescMsgRlimitsNproc {
	return &NullableV0041JobDescMsgRlimitsNproc{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRlimitsNproc) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRlimitsNproc) UnmarshalJSON(src []byte) error {
	v.isSet = true
