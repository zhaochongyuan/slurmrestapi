...
// checks if the V0041OpenapiPartitionRespPartitionsInnerDefaultsTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiPartitionRespPartitionsInnerDefaultsTime{}

// V0041OpenapiPartitionRespPartitionsInnerDefaultsTime DefaultTime in minutes
type V0041OpenapiPartitionRespPartitionsInnerDefaultsTime struct {
...
func NewV0041OpenapiPartitionRespPartitionsInnerDefaultsTime() *V0041OpenapiPartitionRespPartitionsInnerDefaultsTime {
	this := V0041OpenapiPartitionRespPartitionsInnerDefaultsTime{}
	return &this
}
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime struct {
	value *V0041OpenapiPartitionRespPartitionsInnerDefaultsTime
	isSet bool
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) Get() *V0041OpenapiPartitionRespPartitionsInnerDefaultsTime {
	return v.value
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) Set(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsTime) *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime {
	return &NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
