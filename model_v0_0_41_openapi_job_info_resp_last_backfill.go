...
// checks if the V0041OpenapiJobInfoRespLastBackfill type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespLastBackfill{}

// V0041OpenapiJobInfoRespLastBackfill Time of last backfill scheduler run (UNIX timestamp)
type V0041OpenapiJobInfoRespLastBackfill struct {
...
func NewV0041OpenapiJobInfoRespLastBackfill() *V0041OpenapiJobInfoRespLastBackfill {
	this := V0041OpenapiJobInfoRespLastBackfill{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespLastBackfill) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespLastBackfill) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespLastBackfill struct {
	value *V0041OpenapiJobInfoRespLastBackfill
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespLastBackfill) Get() *V0041OpenapiJobInfoRespLastBackfill {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespLastBackfill) Set(val *V0041OpenapiJobInfoRespLastBackfill) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespLastBackfill) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespLastBackfill) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespLastBackfill(val *V0041OpenapiJobInfoRespLastBackfill) *NullableV0041OpenapiJobInfoRespLastBackfill {
	return &NullableV0041OpenapiJobInfoRespLastBackfill{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespLastBackfill) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespLastBackfill) UnmarshalJSON(src []byte) error {
	v.isSet = true
