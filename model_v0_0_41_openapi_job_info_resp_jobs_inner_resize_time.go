...
// checks if the V0041OpenapiJobInfoRespJobsInnerResizeTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerResizeTime{}

// V0041OpenapiJobInfoRespJobsInnerResizeTime Time of last size change (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerResizeTime struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerResizeTime() *V0041OpenapiJobInfoRespJobsInnerResizeTime {
	this := V0041OpenapiJobInfoRespJobsInnerResizeTime{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerResizeTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerResizeTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerResizeTime struct {
	value *V0041OpenapiJobInfoRespJobsInnerResizeTime
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) Get() *V0041OpenapiJobInfoRespJobsInnerResizeTime {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) Set(val *V0041OpenapiJobInfoRespJobsInnerResizeTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerResizeTime(val *V0041OpenapiJobInfoRespJobsInnerResizeTime) *NullableV0041OpenapiJobInfoRespJobsInnerResizeTime {
	return &NullableV0041OpenapiJobInfoRespJobsInnerResizeTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerResizeTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
