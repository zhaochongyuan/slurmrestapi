...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart Time execution began (UNIX timestamp)
type V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
