...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue Maximum number of pending jobs able to accrue age priority in this association and its children
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobsaccrue) UnmarshalJSON(src []byte) error {
	v.isSet = true
