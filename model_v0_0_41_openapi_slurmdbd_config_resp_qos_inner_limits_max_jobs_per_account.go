...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount{}

// V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount MaxSubmitJobsPerAccount
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsPerAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
