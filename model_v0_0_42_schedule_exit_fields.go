...
// checks if the V0042ScheduleExitFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042ScheduleExitFields{}
...
func (o V0042ScheduleExitFields) ToMap() (map[string]interface{}, error) {
