...
// checks if the V0042Uint64NoValStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042Uint64NoValStruct{}

// V0042Uint64NoValStruct struct for V0042Uint64NoValStruct
...
func (o V0042Uint64NoValStruct) MarshalJSON() ([]byte, error) {
...
func (o V0042Uint64NoValStruct) ToMap() (map[string]interface{}, error) {
...
type NullableV0042Uint64NoValStruct struct {
	value *V0042Uint64NoValStruct
	isSet bool
}

func (v NullableV0042Uint64NoValStruct) Get() *V0042Uint64NoValStruct {
	return v.value
}

func (v *NullableV0042Uint64NoValStruct) Set(val *V0042Uint64NoValStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042Uint64NoValStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042Uint64NoValStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042Uint64NoValStruct(val *V0042Uint64NoValStruct) *NullableV0042Uint64NoValStruct {
	return &NullableV0042Uint64NoValStruct{value: val, isSet: true}
}

func (v NullableV0042Uint64NoValStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042Uint64NoValStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
