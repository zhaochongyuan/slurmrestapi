...
// checks if the V0042BfExitFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042BfExitFields{}
...
func (o V0042BfExitFields) ToMap() (map[string]interface{}, error) {
