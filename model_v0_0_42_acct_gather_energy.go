...
// checks if the V0042AcctGatherEnergy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042AcctGatherEnergy{}

// V0042AcctGatherEnergy struct for V0042AcctGatherEnergy
...
// SetCurrentWatts gets a reference to the given V0042Uint32NoValStruct and assigns it to the CurrentWatts field.
...
func (o V0042AcctGatherEnergy) MarshalJSON() ([]byte, error) {
...
func (o V0042AcctGatherEnergy) ToMap() (map[string]interface{}, error) {
...
type NullableV0042AcctGatherEnergy struct {
	value *V0042AcctGatherEnergy
	isSet bool
}

func (v NullableV0042AcctGatherEnergy) Get() *V0042AcctGatherEnergy {
	return v.value
}

func (v *NullableV0042AcctGatherEnergy) Set(val *V0042AcctGatherEnergy) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042AcctGatherEnergy) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042AcctGatherEnergy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042AcctGatherEnergy(val *V0042AcctGatherEnergy) *NullableV0042AcctGatherEnergy {
	return &NullableV0042AcctGatherEnergy{value: val, isSet: true}
}

func (v NullableV0042AcctGatherEnergy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042AcctGatherEnergy) UnmarshalJSON(src []byte) error {
	v.isSet = true
