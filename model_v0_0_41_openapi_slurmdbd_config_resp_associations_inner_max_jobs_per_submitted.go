...
// checks if the V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted{}

// V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted GrpSubmitJobs
type V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted struct {
...
func NewV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted() *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted {
	this := V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted struct {
	value *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) Get() *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) Set(val *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted(val *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted {
	return &NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPerSubmitted) UnmarshalJSON(src []byte) error {
	v.isSet = true
