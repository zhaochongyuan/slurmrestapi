...
// checks if the V0041JobDescMsgBeginTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgBeginTime{}

// V0041JobDescMsgBeginTime Defer the allocation of the job until the specified time (UNIX timestamp)
type V0041JobDescMsgBeginTime struct {
...
func (o V0041JobDescMsgBeginTime) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgBeginTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgBeginTime struct {
	value *V0041JobDescMsgBeginTime
	isSet bool
}

func (v NullableV0041JobDescMsgBeginTime) Get() *V0041JobDescMsgBeginTime {
	return v.value
}

func (v *NullableV0041JobDescMsgBeginTime) Set(val *V0041JobDescMsgBeginTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgBeginTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgBeginTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgBeginTime(val *V0041JobDescMsgBeginTime) *NullableV0041JobDescMsgBeginTime {
	return &NullableV0041JobDescMsgBeginTime{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgBeginTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgBeginTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
