...
// checks if the V0041OpenapiJobInfoRespJobsInnerNodeCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerNodeCount{}

// V0041OpenapiJobInfoRespJobsInnerNodeCount Minimum number of nodes required
type V0041OpenapiJobInfoRespJobsInnerNodeCount struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerNodeCount() *V0041OpenapiJobInfoRespJobsInnerNodeCount {
	this := V0041OpenapiJobInfoRespJobsInnerNodeCount{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerNodeCount) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerNodeCount) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerNodeCount struct {
	value *V0041OpenapiJobInfoRespJobsInnerNodeCount
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) Get() *V0041OpenapiJobInfoRespJobsInnerNodeCount {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) Set(val *V0041OpenapiJobInfoRespJobsInnerNodeCount) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerNodeCount(val *V0041OpenapiJobInfoRespJobsInnerNodeCount) *NullableV0041OpenapiJobInfoRespJobsInnerNodeCount {
	return &NullableV0041OpenapiJobInfoRespJobsInnerNodeCount{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerNodeCount) UnmarshalJSON(src []byte) error {
	v.isSet = true
