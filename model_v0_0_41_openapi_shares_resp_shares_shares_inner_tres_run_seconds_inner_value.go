...
// checks if the V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue{}

// V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue TRES value
type V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue struct {
...
func NewV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue() *V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue {
	this := V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue{}
	return &this
}
...
func (o V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue struct {
	value *V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue
	isSet bool
}

func (v NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) Get() *V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue {
	return v.value
}

func (v *NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) Set(val *V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue(val *V0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) *NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue {
	return &NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue{value: val, isSet: true}
}

func (v NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSharesRespSharesSharesInnerTresRunSecondsInnerValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
