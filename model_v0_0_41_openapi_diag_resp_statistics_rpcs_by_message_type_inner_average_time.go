...
// checks if the V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime{}

// V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime Average time spent processing RPC in seconds
type V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime struct {
...
func NewV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime() *V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime {
	this := V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime{}
	return &this
}
...
func (o V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime struct {
	value *V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime
	isSet bool
}

func (v NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) Get() *V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime {
	return v.value
}

func (v *NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) Set(val *V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime(val *V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) *NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime {
	return &NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiDiagRespStatisticsRpcsByMessageTypeInnerAverageTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
