...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs Maximum number of jobs which can be in a pending or running state at any time in this association and its children
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpsubmitjobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
