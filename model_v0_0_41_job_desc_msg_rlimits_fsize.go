...
// checks if the V0041JobDescMsgRlimitsFsize type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRlimitsFsize{}

// V0041JobDescMsgRlimitsFsize Largest file that can be created, in bytes.
type V0041JobDescMsgRlimitsFsize struct {
...
func NewV0041JobDescMsgRlimitsFsize() *V0041JobDescMsgRlimitsFsize {
	this := V0041JobDescMsgRlimitsFsize{}
	return &this
}
...
func (o V0041JobDescMsgRlimitsFsize) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRlimitsFsize) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRlimitsFsize struct {
	value *V0041JobDescMsgRlimitsFsize
	isSet bool
}

func (v NullableV0041JobDescMsgRlimitsFsize) Get() *V0041JobDescMsgRlimitsFsize {
	return v.value
}

func (v *NullableV0041JobDescMsgRlimitsFsize) Set(val *V0041JobDescMsgRlimitsFsize) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRlimitsFsize) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRlimitsFsize) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRlimitsFsize(val *V0041JobDescMsgRlimitsFsize) *NullableV0041JobDescMsgRlimitsFsize {
	return &NullableV0041JobDescMsgRlimitsFsize{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRlimitsFsize) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRlimitsFsize) UnmarshalJSON(src []byte) error {
	v.isSet = true
