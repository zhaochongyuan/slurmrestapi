...
// checks if the V0042JobInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042JobInfo{}

// V0042JobInfo struct for V0042JobInfo
type V0042JobInfo struct {
	...
	PriorityByPartition []V0042PartPrio `json:"priority_by_partition,omitempty"`
...
// SetAccrueTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the AccrueTime field.
...
// SetArrayJobId gets a reference to the given V0042Uint32NoValStruct and assigns it to the ArrayJobId field.
...
// SetArrayTaskId gets a reference to the given V0042Uint32NoValStruct and assigns it to the ArrayTaskId field.
...
// SetArrayMaxTasks gets a reference to the given V0042Uint32NoValStruct and assigns it to the ArrayMaxTasks field.
...
// SetCoresPerSocket gets a reference to the given V0042Uint16NoValStruct and assigns it to the CoresPerSocket field.
...
// SetBillableTres gets a reference to the given V0042Float64NoValStruct and assigns it to the BillableTres field.
...
// SetCpusPerTask gets a reference to the given V0042Uint16NoValStruct and assigns it to the CpusPerTask field.
...
// SetCpuFrequencyMinimum gets a reference to the given V0042Uint32NoValStruct and assigns it to the CpuFrequencyMinimum field.
...
// SetCpuFrequencyMaximum gets a reference to the given V0042Uint32NoValStruct and assigns it to the CpuFrequencyMaximum field.
...
// SetCpuFrequencyGovernor gets a reference to the given V0042Uint32NoValStruct and assigns it to the CpuFrequencyGovernor field.
...
// SetDeadline gets a reference to the given V0042Uint64NoValStruct and assigns it to the Deadline field.
...
// SetDelayBoot gets a reference to the given V0042Uint32NoValStruct and assigns it to the DelayBoot field.
...
// SetEligibleTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the EligibleTime field.
...
// SetHetJobId gets a reference to the given V0042Uint32NoValStruct and assigns it to the HetJobId field.
...
// SetHetJobOffset gets a reference to the given V0042Uint32NoValStruct and assigns it to the HetJobOffset field.
...
// SetJobResources gets a reference to the given V0042JobRes and assigns it to the JobResources field.
...
// SetLastSchedEvaluation gets a reference to the given V0042Uint64NoValStruct and assigns it to the LastSchedEvaluation field.
...
// SetMaxCpus gets a reference to the given V0042Uint32NoValStruct and assigns it to the MaxCpus field.
...
// SetMaxNodes gets a reference to the given V0042Uint32NoValStruct and assigns it to the MaxNodes field.
...
// SetTasksPerCore gets a reference to the given V0042Uint16NoValStruct and assigns it to the TasksPerCore field.
...
// SetTasksPerTres gets a reference to the given V0042Uint16NoValStruct and assigns it to the TasksPerTres field.
...
// SetTasksPerNode gets a reference to the given V0042Uint16NoValStruct and assigns it to the TasksPerNode field.
...
// SetTasksPerSocket gets a reference to the given V0042Uint16NoValStruct and assigns it to the TasksPerSocket field.
...
// SetTasksPerBoard gets a reference to the given V0042Uint16NoValStruct and assigns it to the TasksPerBoard field.
...
// SetCpus gets a reference to the given V0042Uint32NoValStruct and assigns it to the Cpus field.
...
// SetNodeCount gets a reference to the given V0042Uint32NoValStruct and assigns it to the NodeCount field.
...
// SetTasks gets a reference to the given V0042Uint32NoValStruct and assigns it to the Tasks field.
...
// SetMinimumCpusPerNode gets a reference to the given V0042Uint16NoValStruct and assigns it to the MinimumCpusPerNode field.
...
// SetMinimumTmpDiskPerNode gets a reference to the given V0042Uint32NoValStruct and assigns it to the MinimumTmpDiskPerNode field.
...
// SetPreemptTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the PreemptTime field.
...
// SetPreemptableTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the PreemptableTime field.
...
// SetPreSusTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the PreSusTime field.
...
// SetPriorityByPartition gets a reference to the given []V0042PartPrio and assigns it to the PriorityByPartition field.
...
// SetResizeTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the ResizeTime field.
...
// SetSocketsPerNode gets a reference to the given V0042Uint16NoValStruct and assigns it to the SocketsPerNode field.
...
// SetSubmitTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the SubmitTime field.
...
// SetSuspendTime gets a reference to the given V0042Uint64NoValStruct and assigns it to the SuspendTime field.
...
// SetThreadsPerCore gets a reference to the given V0042Uint16NoValStruct and assigns it to the ThreadsPerCore field.
...
func (o V0042JobInfo) MarshalJSON() ([]byte, error) {
...
func (o V0042JobInfo) ToMap() (map[string]interface{}, error) {
...
type NullableV0042JobInfo struct {
	value *V0042JobInfo
	isSet bool
}

func (v NullableV0042JobInfo) Get() *V0042JobInfo {
	return v.value
}

func (v *NullableV0042JobInfo) Set(val *V0042JobInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042JobInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042JobInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042JobInfo(val *V0042JobInfo) *NullableV0042JobInfo {
	return &NullableV0042JobInfo{value: val, isSet: true}
}

func (v NullableV0042JobInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042JobInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
