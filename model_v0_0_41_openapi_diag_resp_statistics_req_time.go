...
// checks if the V0041OpenapiDiagRespStatisticsReqTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiDiagRespStatisticsReqTime{}

// V0041OpenapiDiagRespStatisticsReqTime When the request was made (UNIX timestamp)
type V0041OpenapiDiagRespStatisticsReqTime struct {
...
func NewV0041OpenapiDiagRespStatisticsReqTime() *V0041OpenapiDiagRespStatisticsReqTime {
	this := V0041OpenapiDiagRespStatisticsReqTime{}
	return &this
}
...
func (o V0041OpenapiDiagRespStatisticsReqTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiDiagRespStatisticsReqTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiDiagRespStatisticsReqTime struct {
	value *V0041OpenapiDiagRespStatisticsReqTime
	isSet bool
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTime) Get() *V0041OpenapiDiagRespStatisticsReqTime {
	return v.value
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTime) Set(val *V0041OpenapiDiagRespStatisticsReqTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiDiagRespStatisticsReqTime(val *V0041OpenapiDiagRespStatisticsReqTime) *NullableV0041OpenapiDiagRespStatisticsReqTime {
	return &NullableV0041OpenapiDiagRespStatisticsReqTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiDiagRespStatisticsReqTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiDiagRespStatisticsReqTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
