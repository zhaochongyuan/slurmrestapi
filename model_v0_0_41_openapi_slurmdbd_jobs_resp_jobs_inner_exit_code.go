...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode Exit code
type V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode() *V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode(val *V0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerExitCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
