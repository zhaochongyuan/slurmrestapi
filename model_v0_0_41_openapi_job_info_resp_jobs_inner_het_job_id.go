...
// checks if the V0041OpenapiJobInfoRespJobsInnerHetJobId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerHetJobId{}

// V0041OpenapiJobInfoRespJobsInnerHetJobId Heterogeneous job ID, if applicable
type V0041OpenapiJobInfoRespJobsInnerHetJobId struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerHetJobId() *V0041OpenapiJobInfoRespJobsInnerHetJobId {
	this := V0041OpenapiJobInfoRespJobsInnerHetJobId{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerHetJobId) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerHetJobId) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerHetJobId struct {
	value *V0041OpenapiJobInfoRespJobsInnerHetJobId
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) Get() *V0041OpenapiJobInfoRespJobsInnerHetJobId {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) Set(val *V0041OpenapiJobInfoRespJobsInnerHetJobId) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerHetJobId(val *V0041OpenapiJobInfoRespJobsInnerHetJobId) *NullableV0041OpenapiJobInfoRespJobsInnerHetJobId {
	return &NullableV0041OpenapiJobInfoRespJobsInnerHetJobId{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerHetJobId) UnmarshalJSON(src []byte) error {
	v.isSet = true
