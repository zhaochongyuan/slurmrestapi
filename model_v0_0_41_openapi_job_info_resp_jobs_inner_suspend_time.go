...
// checks if the V0041OpenapiJobInfoRespJobsInnerSuspendTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerSuspendTime{}

// V0041OpenapiJobInfoRespJobsInnerSuspendTime Time the job was last suspended or resumed (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerSuspendTime struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerSuspendTime() *V0041OpenapiJobInfoRespJobsInnerSuspendTime {
	this := V0041OpenapiJobInfoRespJobsInnerSuspendTime{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerSuspendTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerSuspendTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime struct {
	value *V0041OpenapiJobInfoRespJobsInnerSuspendTime
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) Get() *V0041OpenapiJobInfoRespJobsInnerSuspendTime {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) Set(val *V0041OpenapiJobInfoRespJobsInnerSuspendTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerSuspendTime(val *V0041OpenapiJobInfoRespJobsInnerSuspendTime) *NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime {
	return &NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerSuspendTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
