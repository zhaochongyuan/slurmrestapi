...
// checks if the V0042AssocSharesObjWrap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042AssocSharesObjWrap{}

// V0042AssocSharesObjWrap struct for V0042AssocSharesObjWrap
type V0042AssocSharesObjWrap struct {
	...
	Tres *V0042AssocSharesObjWrapTres `json:"tres,omitempty"`
	...
	Fairshare *V0042AssocSharesObjWrapFairshare `json:"fairshare,omitempty"`
...
// SetSharesNormalized gets a reference to the given V0042Float64NoValStruct and assigns it to the SharesNormalized field.
...
// SetShares gets a reference to the given V0042Uint32NoValStruct and assigns it to the Shares field.
...
func (o *V0042AssocSharesObjWrap) GetTres() V0042AssocSharesObjWrapTres {
	if o == nil || IsNil(o.Tres) {
		var ret V0042AssocSharesObjWrapTres
		return ret
	}
	return *o.Tres
}
...
// SetTres gets a reference to the given V0042AssocSharesObjWrapTres and assigns it to the Tres field.
...
// SetEffectiveUsage gets a reference to the given V0042Float64NoValStruct and assigns it to the EffectiveUsage field.
...
// SetUsageNormalized gets a reference to the given V0042Float64NoValStruct and assigns it to the UsageNormalized field.
...
func (o *V0042AssocSharesObjWrap) GetFairshare() V0042AssocSharesObjWrapFairshare {
	if o == nil || IsNil(o.Fairshare) {
		var ret V0042AssocSharesObjWrapFairshare
		return ret
	}
	return *o.Fairshare
}
...
// SetFairshare gets a reference to the given V0042AssocSharesObjWrapFairshare and assigns it to the Fairshare field.
...
func (o V0042AssocSharesObjWrap) MarshalJSON() ([]byte, error) {
...
func (o V0042AssocSharesObjWrap) ToMap() (map[string]interface{}, error) {
...
type NullableV0042AssocSharesObjWrap struct {
	value *V0042AssocSharesObjWrap
	isSet bool
}

func (v NullableV0042AssocSharesObjWrap) Get() *V0042AssocSharesObjWrap {
	return v.value
}

func (v *NullableV0042AssocSharesObjWrap) Set(val *V0042AssocSharesObjWrap) {
	v.value = val
	v.isSet = true
}

func (v NullableV0042AssocSharesObjWrap) IsSet() bool {
	return v.isSet
}

func (v *NullableV0042AssocSharesObjWrap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0042AssocSharesObjWrap(val *V0042AssocSharesObjWrap) *NullableV0042AssocSharesObjWrap {
	return &NullableV0042AssocSharesObjWrap{value: val, isSet: true}
}

func (v NullableV0042AssocSharesObjWrap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0042AssocSharesObjWrap) UnmarshalJSON(src []byte) error {
	v.isSet = true
