...
// checks if the V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob{}

// V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob MaxWallDurationPerJob
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob struct {
...
func NewV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob {
	this := V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob struct {
	value *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) Get() *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) Set(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob(val *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob {
	return &NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPerJob) UnmarshalJSON(src []byte) error {
	v.isSet = true
