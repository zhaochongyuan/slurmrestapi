...
// checks if the V0042Node type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042Node{}
...
func (o V0042Node) ToMap() (map[string]interface{}, error) {
