...
// checks if the V0042ClusterRec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042ClusterRec{}
...
func (o V0042ClusterRec) ToMap() (map[string]interface{}, error) {
