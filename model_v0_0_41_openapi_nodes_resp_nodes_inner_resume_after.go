...
// checks if the V0041OpenapiNodesRespNodesInnerResumeAfter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiNodesRespNodesInnerResumeAfter{}

// V0041OpenapiNodesRespNodesInnerResumeAfter Number of seconds after the node's state is updated to \"DOWN\" or \"DRAIN\" before scheduling a node state resume
type V0041OpenapiNodesRespNodesInnerResumeAfter struct {
...
func NewV0041OpenapiNodesRespNodesInnerResumeAfter() *V0041OpenapiNodesRespNodesInnerResumeAfter {
	this := V0041OpenapiNodesRespNodesInnerResumeAfter{}
	return &this
}
...
func (o V0041OpenapiNodesRespNodesInnerResumeAfter) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiNodesRespNodesInnerResumeAfter) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiNodesRespNodesInnerResumeAfter struct {
	value *V0041OpenapiNodesRespNodesInnerResumeAfter
	isSet bool
}

func (v NullableV0041OpenapiNodesRespNodesInnerResumeAfter) Get() *V0041OpenapiNodesRespNodesInnerResumeAfter {
	return v.value
}

func (v *NullableV0041OpenapiNodesRespNodesInnerResumeAfter) Set(val *V0041OpenapiNodesRespNodesInnerResumeAfter) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiNodesRespNodesInnerResumeAfter) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiNodesRespNodesInnerResumeAfter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiNodesRespNodesInnerResumeAfter(val *V0041OpenapiNodesRespNodesInnerResumeAfter) *NullableV0041OpenapiNodesRespNodesInnerResumeAfter {
	return &NullableV0041OpenapiNodesRespNodesInnerResumeAfter{value: val, isSet: true}
}

func (v NullableV0041OpenapiNodesRespNodesInnerResumeAfter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiNodesRespNodesInnerResumeAfter) UnmarshalJSON(src []byte) error {
	v.isSet = true
