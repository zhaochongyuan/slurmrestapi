...
// checks if the V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes{}

// V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes MaxNodes
type V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes struct {
...
func NewV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes() *V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes {
	this := V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes{}
	return &this
}
...
func (o V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes struct {
	value *V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes
	isSet bool
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) Get() *V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes {
	return v.value
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) Set(val *V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes(val *V0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes {
	return &NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes{value: val, isSet: true}
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerMaximumsNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
