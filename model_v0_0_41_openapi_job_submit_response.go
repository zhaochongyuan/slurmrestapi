...
type V0041OpenapiJobSubmitResponse struct {
	// Deprecated
	Result *V0041OpenapiJobSubmitResponseResult `json:"result,omitempty"`
	// Submitted Job ID
...
func (o *V0041OpenapiJobSubmitResponse) GetResult() V0041OpenapiJobSubmitResponseResult {
	if o == nil || IsNil(o.Result) {
		var ret V0041OpenapiJobSubmitResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given V0041OpenapiJobSubmitResponseResult and assigns it to the Result field.
// Deprecated
