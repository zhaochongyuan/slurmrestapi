...
// checks if the V0041JobDescMsgRlimitsMemlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRlimitsMemlock{}

// V0041JobDescMsgRlimitsMemlock Locked-in-memory address space
type V0041JobDescMsgRlimitsMemlock struct {
...
func NewV0041JobDescMsgRlimitsMemlock() *V0041JobDescMsgRlimitsMemlock {
	this := V0041JobDescMsgRlimitsMemlock{}
	return &this
}
...
func (o V0041JobDescMsgRlimitsMemlock) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRlimitsMemlock) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRlimitsMemlock struct {
	value *V0041JobDescMsgRlimitsMemlock
	isSet bool
}

func (v NullableV0041JobDescMsgRlimitsMemlock) Get() *V0041JobDescMsgRlimitsMemlock {
	return v.value
}

func (v *NullableV0041JobDescMsgRlimitsMemlock) Set(val *V0041JobDescMsgRlimitsMemlock) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRlimitsMemlock) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRlimitsMemlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRlimitsMemlock(val *V0041JobDescMsgRlimitsMemlock) *NullableV0041JobDescMsgRlimitsMemlock {
	return &NullableV0041JobDescMsgRlimitsMemlock{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRlimitsMemlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRlimitsMemlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
