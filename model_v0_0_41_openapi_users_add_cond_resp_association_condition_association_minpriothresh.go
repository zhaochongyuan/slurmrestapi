...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh Minimum priority required to reserve resources when scheduling
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationMinpriothresh) UnmarshalJSON(src []byte) error {
	v.isSet = true
