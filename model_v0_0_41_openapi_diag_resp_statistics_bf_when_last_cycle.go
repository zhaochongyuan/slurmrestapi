...
// checks if the V0041OpenapiDiagRespStatisticsBfWhenLastCycle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiDiagRespStatisticsBfWhenLastCycle{}

// V0041OpenapiDiagRespStatisticsBfWhenLastCycle When the last backfill scheduling cycle happened (UNIX timestamp)
type V0041OpenapiDiagRespStatisticsBfWhenLastCycle struct {
...
func NewV0041OpenapiDiagRespStatisticsBfWhenLastCycle() *V0041OpenapiDiagRespStatisticsBfWhenLastCycle {
	this := V0041OpenapiDiagRespStatisticsBfWhenLastCycle{}
	return &this
}
...
func (o V0041OpenapiDiagRespStatisticsBfWhenLastCycle) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiDiagRespStatisticsBfWhenLastCycle) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle struct {
	value *V0041OpenapiDiagRespStatisticsBfWhenLastCycle
	isSet bool
}

func (v NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) Get() *V0041OpenapiDiagRespStatisticsBfWhenLastCycle {
	return v.value
}

func (v *NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) Set(val *V0041OpenapiDiagRespStatisticsBfWhenLastCycle) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle(val *V0041OpenapiDiagRespStatisticsBfWhenLastCycle) *NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle {
	return &NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle{value: val, isSet: true}
}

func (v NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiDiagRespStatisticsBfWhenLastCycle) UnmarshalJSON(src []byte) error {
	v.isSet = true
