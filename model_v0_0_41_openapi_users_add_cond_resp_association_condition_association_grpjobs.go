...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs Maximum number of running jobs in this association and its children
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationGrpjobs) UnmarshalJSON(src []byte) error {
	v.isSet = true
