...
// checks if the V0041OpenapiJobInfoRespJobsInnerMaxNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerMaxNodes{}

// V0041OpenapiJobInfoRespJobsInnerMaxNodes Maximum number of nodes usable by the job
type V0041OpenapiJobInfoRespJobsInnerMaxNodes struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerMaxNodes() *V0041OpenapiJobInfoRespJobsInnerMaxNodes {
	this := V0041OpenapiJobInfoRespJobsInnerMaxNodes{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerMaxNodes) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerMaxNodes) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes struct {
	value *V0041OpenapiJobInfoRespJobsInnerMaxNodes
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) Get() *V0041OpenapiJobInfoRespJobsInnerMaxNodes {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) Set(val *V0041OpenapiJobInfoRespJobsInnerMaxNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerMaxNodes(val *V0041OpenapiJobInfoRespJobsInnerMaxNodes) *NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes {
	return &NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerMaxNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
