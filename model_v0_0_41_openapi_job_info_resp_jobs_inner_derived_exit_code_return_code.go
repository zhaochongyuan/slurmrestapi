...
// checks if the V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode{}

// V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode Process return code (numeric)
type V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode() *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode {
	this := V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode struct {
	value *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) Get() *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) Set(val *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode(val *V0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode {
	return &NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerDerivedExitCodeReturnCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
