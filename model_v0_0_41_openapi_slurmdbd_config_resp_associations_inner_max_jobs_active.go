...
// checks if the V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive{}

// V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive MaxJobs
type V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive struct {
...
func NewV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive() *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive {
	this := V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive struct {
	value *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) Get() *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) Set(val *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive(val *V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive {
	return &NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
