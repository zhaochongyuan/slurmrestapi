...
// checks if the V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode{}

// V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode DefMemPerNode
type V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode struct {
...
func NewV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode() *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode {
	this := V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode{}
	return &this
}
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode struct {
	value *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode
	isSet bool
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) Get() *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode {
	return v.value
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) Set(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode(val *V0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode {
	return &NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode{value: val, isSet: true}
}

func (v NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiPartitionRespPartitionsInnerDefaultsPartitionMemoryPerNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
