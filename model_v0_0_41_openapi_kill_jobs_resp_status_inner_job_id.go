...
// checks if the V0041OpenapiKillJobsRespStatusInnerJobId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiKillJobsRespStatusInnerJobId{}

// V0041OpenapiKillJobsRespStatusInnerJobId Job ID that signaling failed
type V0041OpenapiKillJobsRespStatusInnerJobId struct {
...
func NewV0041OpenapiKillJobsRespStatusInnerJobId() *V0041OpenapiKillJobsRespStatusInnerJobId {
	this := V0041OpenapiKillJobsRespStatusInnerJobId{}
	return &this
}
...
func (o V0041OpenapiKillJobsRespStatusInnerJobId) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiKillJobsRespStatusInnerJobId) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiKillJobsRespStatusInnerJobId struct {
	value *V0041OpenapiKillJobsRespStatusInnerJobId
	isSet bool
}

func (v NullableV0041OpenapiKillJobsRespStatusInnerJobId) Get() *V0041OpenapiKillJobsRespStatusInnerJobId {
	return v.value
}

func (v *NullableV0041OpenapiKillJobsRespStatusInnerJobId) Set(val *V0041OpenapiKillJobsRespStatusInnerJobId) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiKillJobsRespStatusInnerJobId) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiKillJobsRespStatusInnerJobId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiKillJobsRespStatusInnerJobId(val *V0041OpenapiKillJobsRespStatusInnerJobId) *NullableV0041OpenapiKillJobsRespStatusInnerJobId {
	return &NullableV0041OpenapiKillJobsRespStatusInnerJobId{value: val, isSet: true}
}

func (v NullableV0041OpenapiKillJobsRespStatusInnerJobId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiKillJobsRespStatusInnerJobId) UnmarshalJSON(src []byte) error {
	v.isSet = true
