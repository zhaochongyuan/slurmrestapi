...
// checks if the V0042OpenapiAssocsResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0042OpenapiAssocsResp{}
...
type _V0042OpenapiAssocsResp V0042OpenapiAssocsResp
...
func (o V0042OpenapiAssocsResp) ToMap() (map[string]interface{}, error) {
...
func (o *V0042OpenapiAssocsResp) UnmarshalJSON(data []byte) (err error) {
	...
	varV0042OpenapiAssocsResp := _V0042OpenapiAssocsResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0042OpenapiAssocsResp)

	if err != nil {
		return err
	}

	*o = V0042OpenapiAssocsResp(varV0042OpenapiAssocsResp)
