...
// checks if the V0041OpenapiJobInfoRespJobsInnerStartTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiJobInfoRespJobsInnerStartTime{}

// V0041OpenapiJobInfoRespJobsInnerStartTime Time execution began, or is expected to begin (UNIX timestamp)
type V0041OpenapiJobInfoRespJobsInnerStartTime struct {
...
func NewV0041OpenapiJobInfoRespJobsInnerStartTime() *V0041OpenapiJobInfoRespJobsInnerStartTime {
	this := V0041OpenapiJobInfoRespJobsInnerStartTime{}
	return &this
}
...
func (o V0041OpenapiJobInfoRespJobsInnerStartTime) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiJobInfoRespJobsInnerStartTime) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiJobInfoRespJobsInnerStartTime struct {
	value *V0041OpenapiJobInfoRespJobsInnerStartTime
	isSet bool
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerStartTime) Get() *V0041OpenapiJobInfoRespJobsInnerStartTime {
	return v.value
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerStartTime) Set(val *V0041OpenapiJobInfoRespJobsInnerStartTime) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerStartTime) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerStartTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiJobInfoRespJobsInnerStartTime(val *V0041OpenapiJobInfoRespJobsInnerStartTime) *NullableV0041OpenapiJobInfoRespJobsInnerStartTime {
	return &NullableV0041OpenapiJobInfoRespJobsInnerStartTime{value: val, isSet: true}
}

func (v NullableV0041OpenapiJobInfoRespJobsInnerStartTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiJobInfoRespJobsInnerStartTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
