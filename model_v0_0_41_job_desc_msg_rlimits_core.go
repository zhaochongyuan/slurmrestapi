...
// checks if the V0041JobDescMsgRlimitsCore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041JobDescMsgRlimitsCore{}

// V0041JobDescMsgRlimitsCore Largest core file that can be created, in bytes.
type V0041JobDescMsgRlimitsCore struct {
...
func NewV0041JobDescMsgRlimitsCore() *V0041JobDescMsgRlimitsCore {
	this := V0041JobDescMsgRlimitsCore{}
	return &this
}
...
func (o V0041JobDescMsgRlimitsCore) MarshalJSON() ([]byte, error) {
...
func (o V0041JobDescMsgRlimitsCore) ToMap() (map[string]interface{}, error) {
...
type NullableV0041JobDescMsgRlimitsCore struct {
	value *V0041JobDescMsgRlimitsCore
	isSet bool
}

func (v NullableV0041JobDescMsgRlimitsCore) Get() *V0041JobDescMsgRlimitsCore {
	return v.value
}

func (v *NullableV0041JobDescMsgRlimitsCore) Set(val *V0041JobDescMsgRlimitsCore) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041JobDescMsgRlimitsCore) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041JobDescMsgRlimitsCore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041JobDescMsgRlimitsCore(val *V0041JobDescMsgRlimitsCore) *NullableV0041JobDescMsgRlimitsCore {
	return &NullableV0041JobDescMsgRlimitsCore{value: val, isSet: true}
}

func (v NullableV0041JobDescMsgRlimitsCore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041JobDescMsgRlimitsCore) UnmarshalJSON(src []byte) error {
	v.isSet = true
